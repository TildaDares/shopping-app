...
export default function Home() {
  ...
  return (
    ...
    >
      <nav className="list-none text-white text-xl md:text-3xl flex justify-end pt-4">
      ...
      <div className="flex justify-center items-center w-screen px-4 flex-col h-full">
        <p
